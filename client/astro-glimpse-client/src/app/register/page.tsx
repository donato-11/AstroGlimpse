      ...
      <div className="relative min-h-screen text-white flex flex-col items-center justify-center px-4">
        ...
        ">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            {/* Confirm password */}
            <div className="flex flex-col gap-1.5">
              <label htmlFor="confirm-password" className="text-xs font-light tracking-[0.16em] uppercase text-gray-500">
                Confirm password
              </label>
              <input
                id="confirm-password"
                ...
                className={`
                  w-full rounded-xl px-4 py-2.5
                  text-sm font-light text-white placeholder-white/20
                  bg-white/[0.04] backdrop-blur-md outline-none
                  transition-all duration-200
                  focus:shadow-[0_0_0_1px_rgba(255,255,255,0.10),0_0_16px_rgba(255,255,255,0.04)]
                  ${passwordError
              ...
              />
              {passwordError && (
                <p className="text-xs font-light tracking-wide text-red-400/80 mt-0.5">
                  {passwordError}
                </p>
              )}
            </div>
